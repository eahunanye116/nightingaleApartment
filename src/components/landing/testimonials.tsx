...
const testimonials = [
  {
    name: "Adeola Adebayo",
    review: "From the moment I arrived, the service was exceptional. The apartment was pristine, and the staff went above and beyond to ensure my comfort. Every detail was thoughtfully considered. Nightingale truly feels like a home away from home, but better. I can't wait for my next visit.",
    rating: 5,
  },
  {
    name: "Chiamaka Nwosu",
  ...
  {
    name: "Emeka Okafor",
    review: "Fantastic attention to detail. Top-notch amenities and a really comfortable stay. It’s the little things that count.",
    rating: 5,
  },
  {
    name: "Fatima Bello",
   ...
   {
    name: "Tunde Bakare",
    review: "Stylish, clean, and comfortable. 10/10.",
    rating: 5,
  },
  {
    name: "Aisha Ibrahim",
    review: "A truly luxurious experience from start to finish. The staff are incredibly professional and friendly, and the facilities are second to none in the city. I especially enjoyed the on-site restaurant.",
    rating: 5,
  }
];

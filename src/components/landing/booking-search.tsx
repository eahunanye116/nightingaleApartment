        ...
        <div className="mx-auto max-w-screen-md px-4">
            <Card className="shadow-2xl">
                ...
                <CardContent>
                    ...
                    <Input value={name} onChange={(e) => setName(e.target.value)} className="py-6 text-base" type="text" placeholder="Your Name" />
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <Input value={checkIn} onChange={(e) => setCheckIn(e.target.value)} className="py-6 text-base" type="text" placeholder="Check in" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = 'text'}/>
                        <Input value={checkOut} onChange={(e) => setCheckOut(e.target.value)} className="py-6 text-base" type="text" placeholder="Check out" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = 'text'}/>
                    </div>
                    <Input value={numGuests} onChange={(e) => setNumGuests(e.target.value)} className="py-6 text-base" type="number" placeholder="Number of guests" min="1" />
